                                    ...
                                    <li class="big clear product_block"  
                                        ...
                                        <div class="figure-item">
                                            ...
                                            <ul class="function">
                                                ...
                                                <li class="share item_user"><a href="<?php echo 'user/' . $productArr[$i]->user_name . '/added'; ?>"><?php echo $username; ?></a></li>
                                    ...
                                    <li class="mid clear product_block"
                                        ...
                                        <div class="figure-item">
                                            ...
                                            <ul class="function">
                                                ...
                                                <li class="share item_user"><a href="<?php echo 'user/' . $productArr[$i + 1]->user_name . '/added'; ?>"><?php echo $username; ?></a></li>
                                    ...
                                    <li class="mid product_block"
                                        ...
                                        <div class="figure-item">
                                            ...
                                            <ul class="function">
                                                ...
                                                <li class="share item_user"><a href="<?php echo 'user/' . $productArr[$i + 2]->user_name . '/added'; ?>"><?php echo $username; ?></a></li>
