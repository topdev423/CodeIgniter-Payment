      ...
      <div id="content">
        <div class="wrapper timeline normal">
          <ul class="user-tab">
            ...
            <li class="profile-active"><a href="user/<?php echo $userProfileDetails->row()->user_name;?>/owns" class="current"><b><?php if($this->lang->line('display_owns') != '') { echo stripslashes($this->lang->line('display_owns')); } else echo "Owns"; ?></b> <small><?php echo $name_own;?></small></a></li>
