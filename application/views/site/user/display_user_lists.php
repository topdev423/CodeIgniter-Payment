      ...
      <div id="content">
        <div class="wrapper timeline normal">
          <ul class="user-tab">
            ...
            <li class="profile-active"><a href="user/<?php echo $userProfileDetails->row()->user_name;?>/lists"><b><?php if($this->lang->line('display_lists') != '') { echo stripslashes($this->lang->line('display_lists')); } else echo "Lists"; ?></b> <small><?php echo $name_list;?></small></a></li>
          ...
          <ol class="stream" id="list_stream">
          <?php 
          ...
          ?>
            <li class="big clear profile-area">
              ...
              <span class="username" style="width: 100%;text-align:center;margin-top:2px;"><em><a href="user/<?php echo $userProfileDetails->row()->user_name;?>/lists/<?php echo  $listDetailsRow->id;?>/settings"></a></em></span> 
              </em>
              <?php 
              }
              ?>
