      ...
      <div id="content">
        <div class="wrapper timeline normal">
          <ul class="user-tab">
            ...
            <li class="profile-active"><a href="user/<?php echo $userProfileDetails->row()->user_name;?>" ><b><?php echo LIKED_BUTTON;?></b> <small><?php echo $name_rated;?></small></a></li>
            ...
            <li class="big clear profile-area">
              ...
              <img src="images/product/<?php echo $imgName;?>" data-width="310" data-height="310"> </span> 
                ...
                <ul class="function">
                  ...
                  <li class="share item_rating"><a href="#"><?php echo round($productLikeDetailsRow->rating, 2); ?> <img src="images/icon_star.png"></a></li>
                </ul>
