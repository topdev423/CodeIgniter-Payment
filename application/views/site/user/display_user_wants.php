      ...
      <div id="content">
        <div class="wrapper timeline normal">
          <ul class="user-tab">
            ...
            <li class="profile-active"><a href="user/<?php echo $userProfileDetails->row()->user_name;?>/wants"><b><?php if($this->lang->line('display_wants') != '') { echo stripslashes($this->lang->line('display_wants')); } else echo "Wants"; ?></b> <small><?php echo $name_want;?></small></a></li>
            ...
            <li class="big clear profile-area">
              ...
              <span class="username"><em><a href="<?php if ($productLikeDetailsRow->user_name == ''){echo 'user/administrator';}else {echo 'user/'.$productLikeDetailsRow->user_name;}?>"><?php if ($productLikeDetailsRow->user_name == ''){echo 'administrator';}else {echo $productLikeDetailsRow->full_name;}?></a> + <?php echo $productLikeDetailsRow->likes;?></em></span> 
                ...
                <ul class="function">
                  ...
                  <li class="share item_rating"><a href="#"><?php if($productLikeDetailsRow->rating != ''){ echo round($productLikeDetailsRow->rating, 2);} else {echo 0;} ?> <img src="images/icon_star.png"></a></li>
                </ul>
